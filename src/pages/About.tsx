      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="relative group reveal-left">
            <div className="absolute inset-0 bg-[#81314c]/10 rounded-3xl -rotate-3 transform scale-102 transition-transform duration-500 group-hover:rotate-0 select-none" />
            <img
              src={aboutData.aboutImage}
              alt={aboutData.title}
              className="relative z-10 w-full h-[400px] md:h-[550px] object-cover rounded-3xl shadow-2xl border border-[#eddee3] transition-transform duration-500 group-hover:scale-[1.01]"
            />
          </div>
        ...
        {/* Timeline Layout */}
        <div id="timeline-container" className="mb-24 py-12 bg-white rounded-3xl border border-[#eddee3] px-6 md:px-12 reveal">
          ...
          <div className="relative border-l border-gray-200 ml-4 md:ml-32 md:mr-32 space-y-12">
            {milestones.map((item, index) => (
              <div key={index} className="relative pl-8 group">
                ...
                {/* Card Details */}
                <div className="space-y-1 bg-[#fbfaf9] border border-gray-100 p-6 rounded-3xl shadow-sm luxury-card-hover">
        ...
        {/* CTA to Consultation */}
        <div className="bg-[#81314c]/5 rounded-3xl p-8 md:p-12 text-center border border-[#81314c]/20 reveal">
